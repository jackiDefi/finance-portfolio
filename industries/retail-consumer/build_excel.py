#!/usr/bin/env python3
"""
Retail & Consumer — simple 4-sheet operating model (Cover / Inputs / Forecast / Valuation).
...
Run:  python3 build_excel.py   ->   writes retail-consumer-model.xlsx
"""
...
# ----------------------------------------------------------------------------
# Industry configuration (defaults approximate Costco FY2024)
# ----------------------------------------------------------------------------
CONFIG = {
    "industry":  "Retail & Consumer",
    "company":   "Costco Wholesale (NASDAQ: COST)",
    ...
    "inputs": [
        ...
        ("Revenue (Y0)",                254.5,  "num"),
        ("Revenue growth",              0.07,   "pct"),
        ("EBITDA margin",               0.047,  "pct"),
        ("D&A / revenue",               0.008,  "pct"),
        ("Capex intensity",             0.018,  "pct"),
        ("Tax rate",                    0.25,   "pct"),
        ("WACC",                        0.075,  "pct"),
        ("Terminal growth",             0.03,   "pct"),
        ("Net debt (Y0)",               -5.0,   "num"),
        ("Shares outstanding (m)",      445,    "int"),
...
def build(cfg, out_path):
    ...
    rows = [
        ...
        "  Net debt is negative (net cash), so interest is income.",
...
if __name__ == "__main__":
    ...
    build(CONFIG, os.path.join(here, "retail-consumer-model.xlsx"))
