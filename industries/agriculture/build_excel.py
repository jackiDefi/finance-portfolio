#!/usr/bin/env python3
"""
Agriculture — simple 4-sheet operating model (Cover / Inputs / Forecast / Valuation).
...
Run:  python3 build_excel.py   ->   writes agriculture-model.xlsx
"""
...
CONFIG = {
    ...
    "inputs": [
        ...
        ("EBITDA margin",               0.055,  "pct"),
        ("D&A / revenue",               0.015,  "pct"),
        ("Capex intensity",             0.018,  "pct"),
        ("Tax rate",                    0.23,   "pct"),
        ("WACC",                        0.08,   "pct"),
        ("Terminal growth",             0.02,   "pct"),
        ("Net debt (Y0)",               8.5,    "num"),
        ("Shares outstanding (m)",      500,    "int"),
...
if __name__ == "__main__":
    ...
    build(CONFIG, os.path.join(here, "agriculture-model.xlsx"))
